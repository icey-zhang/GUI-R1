...
output_dir=${2:-"work_dirs/Qwen2.5-VL-32B-SFT-exp1"}
pretrained=${3:-"Qwen/Qwen2.5-VL-32B-Instruct"}
...
lr=1e-5
batch_size=1
grad_accum_steps=$(( NNODES <= 8 ? 8 : (NNODES <= 16 ? 4 : 2) ))

# Training entry point
entry_file=qwenvl/train/train_qwen.py

# Output configuration
run_name="qwen2.5vl-32b-baseline"
