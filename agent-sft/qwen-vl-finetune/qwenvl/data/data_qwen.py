...
class LazySupervisedDataset(Dataset):
    ...
    def __init__(self, processor, data_args):
        ...
        self.processor.max_pixels = data_args.max_pixels
        self.processor.min_pixels = data_args.min_pixels
        # self.processor.size["longest_edge"] = data_args.max_pixels
        # self.processor.size["shortest_edge"] = data_args.min_pixels
        rank0_print(
    ...
    def process_video(self, video_file):
        ...
        second_per_grid_ts = [
            self.processor.temporal_patch_size / fps
        ] * len(grid_thw)
    ...
    def _get_item(self, i) -> Dict[str, torch.Tensor]:
        ...
        if "image" in sources[0] and sources[0]["image"] is not None:
            ...
            if not isinstance(grid_thw, Sequence):
                ...
                grid_thw = [grid_thw]
            grid_thw_merged = [
                merged_thw.prod() // self.processor.merge_size**2
...
def make_supervised_data_module(
    ...
    train_dataset = LazySupervisedDataset(processor=processor, data_args=data_args)
    if data_args.data_flatten:
        data_collator = FlattenedDataCollatorForSupervisedDataset(tokenizer=processor.tokenizer)
        return dict(
